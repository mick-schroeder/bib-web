...
Handlebars.registerPartial('nav', fs.readFileSync('src/html/includes/nav.hbs', 'utf-8'));
Handlebars.registerPartial('sidebar', fs.readFileSync('src/html/includes/sidebar.hbs', 'utf-8'));
